...
👩‍💻 Мои основные инструменты: HTML5, CSS3, JS, TS, Webpack, Git, REST API, React, Redux, RTK, RTK-Query, Mobx;  

🎓 Имею высшее образование, являюсь магистром в инженерной специальности - Институт высоких технологий.          
