...
- Добавлять анимации, hover-эффекты, focus, active в стилистике сайта.
...
- Работать с REST API.
- Настроить сервер на Linux Ubuntu.
- Настроить веб-сервер на Nginx и Apache и многое другое
